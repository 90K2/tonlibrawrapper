package com.tonlibwrapper.tonlibranext.contracts.wallet

import com.tonlibwrapper.tonlibranext.common.exceptions.SomethingWentWrong
import com.tonlibwrapper.tonlibranext.common.utcLongNow
import com.tonlibwrapper.tonlibranext.constants.SendMode
import com.tonlibwrapper.tonlibranext.toSnakeData
import com.tonlibwrapper.tonlibranext.toWalletTransfer
...
class HighloadWalletV2(
    ...
    suspend fun transfer(liteApi: LiteApi, transfers: List<WalletTransfer>): Int {
        require(transfers.isNotEmpty() && transfers.size <= 254) { throw SomethingWentWrong("wrong transfers size") }
        ...
        transfer(liteApi, listOf(
            WalletTransfer {
                ...
                messageData = MessageData.raw(
                    body = buildCell {
                        storeUInt(0, 32)
                        storeRef { storeTlb(SnakeData, comment.toByteArray(Charsets.UTF_8).toSnakeData()) }
                    }
                )
            }
        ))
